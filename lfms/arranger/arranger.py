...
def _assemble(
    ...
    composition = Composition(
        ...
        drop_intensity=plan.drop_intensity,
        bass_distortion=plan.bass_distortion,
        supersaw_brightness=plan.supersaw_brightness,
        sidechain_amount=plan.sidechain_amount,
        bpm=plan.bpm,
